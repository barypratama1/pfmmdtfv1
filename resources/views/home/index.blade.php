<!--Slider Start-->
         ...
         <!--Service Area End--> 
          ...
          <!--Blog Start-->
<section class="h2-news wf100 p80 blog" style="background: url({{ asset('assets/aws/images/aboutbg.jpg') }}) no-repeat; background-size: cover;">
   <div class="blog-grid">
      <div class="container">
         <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6"> <a href="{{ asset('berita/kategori/berita') }}" class="view-more">Indeks</a> </div>
            <div class="col-md-12">
               <hr>
            </div>
         </div>
            ...
            <div class="col-md-4 col-sm-6" >
               <div class="blog-post">
                  ...
                  <div class="post-txt">
                     ...
                     <a href="{{ asset('berita/read/'.$berita->slug_berita) }}" class="btn btn-success">Selengkapnya</a>
                  </div>
               </div>
            </div>
            <!--Blog Small Post End--> 
...
<!--Blog End-->
                  ...
                  <div class="row">
                     <div class="col-lg-7">
                        <div class="about-text">
                           ...
                           <?php echo substr_replace($site_config->tentang, ".  ", 593); ?></br></br>
                           <a href="{{ asset('about') }}" class="btn btn-info btn-lg">Selengkapnya</a>
                        </div>
                     </div>
                     <div class="col-lg-5">
         ...
         <!--About Section Start-->
         <section class="home2-about wf100 p100 gallery" style="background: url({{ asset('assets/aws/images/aboutbg.jpg') }}) no-repeat; background-size: cover;">
            <div class="container">
               <div class="row">
                  <div class="col-md-5">
                  ...
                  <div class="col-md-7">
                     <div class="h2-about-txt">
                        ...
                        <a class="btn btn-success" href="{{ asset('video') }}">Selengkapnya</a> 
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="col-md-12">
            ...
            <div id="testimonials" class="owl-carousel owl-theme">
               ...
               <div class="item">
                  ...
                  <hr>
                  <?php echo \Illuminate\Support\Str::limit(strip_tags($kategori_download->keterangan), 50, $end='...') ?>
                  <div class="tuser">
                     <a href="{{ asset('download/kategori/'.$kategori_download->slug_kategori_download) }}" class="btn btn-success"> Selengkapnya</a>
                  </div>
               </div>
