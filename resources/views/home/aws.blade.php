   ...
   <div class="about-video-section wf100">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-5">
               <a href="#"><img src="{{ asset('assets/upload/image/'.$site_config->gambar) }}" alt="{{ $site_config->nama_singkat }}" class="img img-fluid img-thumbnail" onclick="window.open(this.src, '_blank');"></a>
            </div>
         </div>
      </div>
   </div>
