            ...
            <div class="col-md-6 col-sm-12">
               <div class="blog-post">
                  ...
                  <div class="post-txt">
                     ...
                     <ul class="post-meta">
                        <li> <a href="{{ asset('galeri/detail/'.$galeri->id_galeri) }}"><i class="fas fa-calendar-alt"></i> 
                        {{ tanggal('tanggal_id',$galeri->tanggal) }}</a> </li>
                        <li> <a href="{{ asset('galeri/detail/'.$galeri->id_galeri) }}"><i class="fas fa-comments"></i> 
                        {{ $galeri->nama_kategori_galeri }}</a> </li>
                     </ul>
